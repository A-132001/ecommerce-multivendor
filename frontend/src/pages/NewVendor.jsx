...
import { createStore, listCategories } from "../api/api.js";
...
const NewVendor = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("category_id", data.categories);
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80')",
          ...
          <Col md={8} lg={6} xl={5}>
            ...
            >
              ...
              <p className="text-center text-muted mt-4 mb-0 small">
                ...
                <a href="/vendor-login" style={{ color: "#e67e22" }}>
                  Sign in
                </a>
              </p>
            </Card>
